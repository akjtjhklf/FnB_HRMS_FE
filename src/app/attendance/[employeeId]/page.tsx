...
import { Avatar, Tabs, Select, Button as AntButton } from "antd";
...
export default function EmployeeAttendancePage() {
  ...
  const stats = useMemo(() => {
    ...
    return {
      ...
      avgHoursPerDay:
        completedDays > 0
          ? Math.round(totalMonthlyHours.totalMinutes / completedDays / 60 * 10) / 10
          : 0,
    };
    ...
    () => [
      ...
      },
      {
        ...
        render: (_, record) => {
          ...
          return (
            <span className="font-semibold text-blue-600">{result.display}</span>
          );
        },
      },
      {
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 mx-2">
        <div className="px-6 py-4">
          <CustomDataTable<AttendanceLog>
            ...
            pagination={{
              current: 1,
              pageSize: 31, // Tối đa 31 ngày trong tháng
